...
local categories = {
	...
	},
	{
		...
		class = Enum.ItemClass.Container,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Container) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_GEMS,
		class = Enum.ItemClass.Gem,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Gem) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_ITEM_ENHANCEMENT,
		class = Enum.ItemClass.ItemEnhancement,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.ItemEnhancement) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_CONSUMABLES,
		class = Enum.ItemClass.Consumable,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Consumable) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_GLYPHS,
		class = Enum.ItemClass.Glyph,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Glyph) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_TRADE_GOODS,
		class = Enum.ItemClass.Tradegoods,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Tradegoods) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_RECIPES,
		class = Enum.ItemClass.Recipe,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Recipe) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_BATTLE_PETS,
		class = Enum.ItemClass.Battlepet,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Battlepet) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_QUEST_ITEMS,
		class = Enum.ItemClass.Questitem,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Questitem) },
		isCollapsed = true,
	},
	{
		name = AUCTION_CATEGORY_MISCELLANEOUS,
		class = Enum.ItemClass.Miscellaneous,
		subClasses = { GetAuctionItemSubClasses(Enum.ItemClass.Miscellaneous) },
		isCollapsed = true,
	},
}
